...
abstract class RustMdDart extends FlutterRustBridgeBase<RustMdDartWire> {
  factory RustMdDart(ffi.DynamicLibrary dylib) =>
      RustMdDartImpl.raw(RustMdDartWire(dylib));
...
class RustMdDartWire implements FlutterRustBridgeWireBase {
  ...
  RustMdDartWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  RustMdDartWire.fromLookup(
  ...
  late final _new_list_elementPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<wire_list_element> Function(
              ffi.Int32)>>('new_list_element');
  late final _new_list_element = _new_list_elementPtr
      .asFunction<ffi.Pointer<wire_list_element> Function(int)>();
